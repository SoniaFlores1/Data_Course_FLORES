...
#You would have to download transformr package.  
...
anim_save("~/Desktop/myanimation.gif",ANIM ) #Let's you save the animations as a gif
...
#Now all previous points are shown to show an actual moving line insted of moving points
...
#If you want to make a bargraph that has two variables, use geom_col
